...
// Int Event
// ============================================
// Broadcast event with a single int payload (damage, score delta, xp gained).
//
// USAGE: Create an asset (right-click → Create → Ludocore/Events/Int Event),
//        rename it semantically (DamageEvent.asset, ScoreChangedEvent.asset,
//        XPGainedEvent.asset), and reference it from systems that raise or
//        listen.
//
// NAMING: The class is generic; the ASSET NAME carries the meaning.
//         Never leave assets named "NewIntEvent" — rename immediately.
//
// FOR MULTI-FIELD PAYLOADS (Day+Hour, ResourceData+amount, etc.):
//        copy ScheduledTimeEvent.cs as a template instead.
// ============================================
...
namespace Ludocore
{
    [CreateAssetMenu(fileName = "NewIntEvent", menuName = "Ludocore/Events/Int Event")]
    public class IntEvent : ScriptableObject
    {
        ...
        /// <summary>Raised when Raise(int) is called. Subscribe in OnEnable, unsubscribe in OnDisable.</summary>
