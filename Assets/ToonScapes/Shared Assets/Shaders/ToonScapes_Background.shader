	...
	SubShader
	{
		...
		Pass
		{
						 ...
						 ) : SV_Target
			{
				...
				#endif
				float2 uv_MainTexture18 = input.ase_texcoord2.xy;
				float4 tex2DNode18 = tex2D( _MainTexture, uv_MainTexture18 );
				float2 uv_NormalMap51 = input.ase_texcoord2.xy;
				...
				float4 temp_output_212_0 = ( staticSwitch213 * ( ( ( tex2DNode18 * tex2D( _TextureRamp, temp_cast_0 ) ) * HalfLambert96 ) + ( tex2DNode18 * tex2D( _TextureRamp, (saturate( localAdditionalLightsLambertMask170x305_g61167 )*RampScale665 + RampOffset666).xy ) ) ) );
		...
		Pass
		{
								 ...
								 )
			{
				...
				float3 localAdditionalLightsLambertMask170x305_g61167 = AdditionalLightsLambertMask170x( WorldPosition305_g61167 , ScreenUV305_g61167 , WorldNormal305_g61167 , ShadowMask305_g61167 );
				float4 temp_output_212_0 = ( staticSwitch213 * ( ( ( tex2DNode18 * tex2D( _TextureRamp, temp_cast_0 ) ) * HalfLambert96 ) + ( tex2DNode18 * tex2D( _TextureRamp, (saturate( localAdditionalLightsLambertMask170x305_g61167 )*RampScale665 + RampOffset666).xy ) ) ) );
				float4 lerpResult761 = lerp( temp_output_212_0 , unity_FogColor , saturate( ( ( ( ( 1.0 - input.ase_texcoord8.xyz.y ) + _FogHeight ) / 10.0 ) * ( _FogDensity / 10.0 ) ) ));
				#ifdef _ENABLEFOG_ON
				float4 staticSwitch721 = lerpResult761;
				#else
				float4 staticSwitch721 = temp_output_212_0;
...
ASEEND*/
//CHKSM=663BE110FCCBAEA877B31C104E75CA943050DAC6